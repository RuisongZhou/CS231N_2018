...
def rnn_step_forward(x, prev_h, Wx, Wh, b):
    ...
    ##############################################################################
    affine_h = np.dot(prev_h, Wh)
    affine_x = np.dot(x, Wx) +b
    new_h = affine_x + affine_h
...
def lstm_step_forward(x, prev_h, prev_c, Wx, Wh, b):
    ...
    cache = (i, f, o, g, next_c, prev_h, prev_c, Wx, Wh, x)
    ##############################################################################
    #                               END OF YOUR CODE                             #
    ##############################################################################
...
def lstm_step_backward(dnext_h, dnext_c, cache):
    ...
    #############################################################################
    i, f, o, g, next_c, prev_h, prev_c, Wx, Wh, x = cache
...
def lstm_forward(x, h0, Wx, Wh, b):
    ...
    cache = []
    for i in range(T):
        next_h, next_c, c = lstm_step_forward(x[:, i, :], next_h, next_c, Wx, Wh, b)
        h[:, i, :] = next_h
        cache.append(c)
    ##############################################################################
    #                               END OF YOUR CODE                             #
...
def lstm_backward(dh, cache):
    ...
    #############################################################################
    i, f, o, g, next_c, prev_h, prev_c, Wx, Wh, x = cache[0]
    N, D = x.shape
    N, T, H = dh.shape
    _, H = prev_h.shape
    dx = np.zeros((N, T, D))
